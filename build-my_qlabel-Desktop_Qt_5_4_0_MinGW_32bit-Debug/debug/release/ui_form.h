...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        groupBox->setGeometry(QRect(10, 10, 161, 461));
        layoutWidget = new QWidget(groupBox);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 20, 139, 405));
        ...
        FloorInput = new QLineEdit(layoutWidget);
        FloorInput->setObjectName(QStringLiteral("FloorInput"));

        verticalLayout->addWidget(FloorInput);
        ...
        typeInput = new QLineEdit(layoutWidget);
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        label_7->setText(QApplication::translate("Form", "Floor ", 0));
        label_6->setText(QApplication::translate("Form", "Type", 0));
