...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyGraphicsView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 15, 14), // "sendMousePoint"
...
QT_MOC_LITERAL(7, 68, 14), // "mouseMoveEvent"
QT_MOC_LITERAL(8, 83, 4) // "move"

    },
    "MyGraphicsView\0sendMousePoint\0\0point\0"
    "mousePressEvent\0QMouseEvent*\0e\0"
    "mouseMoveEvent\0move"
};
...
void MyGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGraphicsView::sendMousePoint)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyGraphicsView::sendMousePoint(QPointF _t1)
{
